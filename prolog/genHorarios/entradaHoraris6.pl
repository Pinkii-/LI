...
assig(1,6,3,[3],[1,3,5]).
assig(1,7,3,[1,2,3],[3,4,5]).
assig(1,8,4,[2,3],[3,4]).
assig(1,9,3,[2],[1,2,3,5]).
assig(1,10,3,[1,2,3],[4,5]).
assig(1,11,2,[1,3],[1,3,5]).

assig(1,12,3,[1,3],[1,3,4,5]).
assig(1,13,4,[1,2],[1,3,5]).
assig(1,14,2,[1,2,3],[1,2,4,5]).
assig(1,15,4,[3],[1,2,3]).
assig(1,16,3,[1,2,3],[2,5]).
assig(1,17,3,[1,2,3],[1]).
assig(1,18,3,[1,2,3],[3]).

assig(1,19,4,[1,2,3],[3]).
assig(1,20,4,[3],[1,3,4,5]).
assig(1,21,3,[2,3],[2,3]).
assig(1,22,2,[2,3],[2,3,4,5]).
assig(1,23,5,[1],[3]).
